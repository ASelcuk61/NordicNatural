package com.nordicnaturals.qa.util;
...
public class ElementUtil {
	...
	public String doGetText(By locator) {
		...
		try {
			...
			System.out.println("some exception got occured while getting text from " + locator);
		}
		return null;
	}
	...
	/**
	 * This method will help us locate elements and then store them in a list
	 * @param locator
	 * @return
	 */
